...
\author{ABDELRAHMAN ABDELLATİF}
\title{MÜŞTERİ ÖMÜR DEĞERİ PERFORMANS VE DOĞRULUK ANALİZİ}
...
\begin{frame}
    \frametitle{içindekiler listesi}
...
\begin{frame}{Effects}
    ...
    \only<1, 3>
    {
        \begin{textblock}{0.3}(0.45, 0.55)
            \includegraphics[width = \textwidth]{images/MathDept-apollon}
        \end{textblock}
    }
\end{frame}
